...
OBJS=sgetopt.o
# TODO: This should be split or symlinks from this list should be eliminated
# altogether.  Or else the installation might not work correctly (the symlink
# would not be overwritten).  The only symlink left being pad.1, it should be
# removed very soon.
SMANS=pad.1 whle.1 repeat.1 # symlinks to manpages or copies generated by asciidoc
